...
switch GUI.Source
    ...
    case 'TRC_Blast'
        ...
        data_eog_OY_continue = Extract_datas_Clinic_TRC(GUI.BLAST_Object.Path_TRC, chan_eog, win_OY, double(GUI.BLAST_Object.Fs), 0, 20);
        data_eog_CY_continue = Extract_datas_Clinic_TRC(GUI.BLAST_Object.Path_TRC, chan_eog, win_CY, double(GUI.BLAST_Object.Fs), 0, 20);
