...
uicontrol('Style', 'frame', 'Position', [1 220 250 180],...
    'BackgroundColor', GUI.Colors(1,:), 'ForegroundColor', [.2 .2 .2]);
GUI.RTB.param_artefact.th_abs_OY = uicontrol('Style', 'edit', 'String', '100',...
...
uicontrol('Style', 'text', 'String', {'Open Eyes'},...
    ...
    'HorizontalAlignment', 'left', 'BackgroundColor', GUI.Colors(1,:));
GUI.RTB.param_artefact.th_abs_CY = uicontrol('Style', 'edit', 'String', '100',...
...
uicontrol('Style', 'frame', 'Position', [5 340 220 1],...
    'BackgroundColor', [.5 .5 .5], 'ForegroundColor', [.5 .5 .5]);
GUI.RTB.param_artefact.th_sd = uicontrol('Style', 'edit', 'String', '2.5',...
    'Position', [20 300 60 20], 'FontSize', 15, 'Tag', 'param_th_sd');
uicontrol('Style', 'text', 'String', {'(standard deviation)'},...
    'Position', [81 300 150 20], 'FontSize', 10,...
    'HorizontalAlignment', 'left', 'BackgroundColor', GUI.Colors(1,:));

uicontrol('Style', 'frame', 'Position', [5 280 220 1],...
    'BackgroundColor', [.5 .5 .5], 'ForegroundColor', [.5 .5 .5]);
GUI.RTB.param_artefact.pct = uicontrol('Style', 'edit', 'String', '0.2',...
    'Position', [20 240 60 20], 'FontSize', 15, 'Tag', 'param_pct');
uicontrol('Style', 'text', 'String', {'(% of signal rejected)'},...
    'Position', [81 240 100 20], 'FontSize', 10,...
    'HorizontalAlignment', 'left', 'BackgroundColor', GUI.Colors(1,:));

% ICA
GUI.RTB.param_artefact.ICA = {};
uicontrol('Style', 'text', 'String', {'ICA Components'},...
    'Position', [10 178 200 20], 'FontSize', 15,...
    'HorizontalAlignment', 'left', 'BackgroundColor', GUI.Colors(1,:));
uicontrol('Style', 'frame', 'Position', [1 117 250 60],...
    'BackgroundColor', GUI.Colors(1,:), 'ForegroundColor', [.2 .2 .2]);
GUI.RTB.param_artefact.ICA.Open = uicontrol('Style', 'edit', 'String', 'auto',...
    'Position', [20 150 60 20], 'FontSize', 15, 'Tag', 'ICA Open Eyes');
uicontrol('Style', 'text', 'String', {'Open Eyes'},...
    'Position', [90 152 100 20], 'FontSize', 15,...
    'HorizontalAlignment', 'left', 'BackgroundColor', GUI.Colors(1,:));
GUI.RTB.param_artefact.ICA = uicontrol('Style', 'edit', 'String', 'auto',...
    'Position', [20 125 60 20], 'FontSize', 15, 'Tag', 'ICA Close Eyes');
uicontrol('Style', 'text', 'String', {'Close Eyes'},...
    'Position', [90 127 100 20], 'FontSize', 15,...
    'HorizontalAlignment', 'left', 'BackgroundColor', GUI.Colors(1,:));


uicontrol('Style', 'frame', 'Position', [1 10 150 80],...
    'BackgroundColor', GUI.Colors(1,:), 'ForegroundColor', [.2 .2 .2]);
uicontrol('Style', 'text', 'String', {'Select frequency bands definition'},...
    'Position', [10 45 130 40], 'HorizontalAlignment', 'left',...
    'FontSize', 15, 'BackgroundColor', GUI.Colors(1,:));
GUI.RTB.param_band = uicontrol('Style', 'popupmenu', 'String', {'fix', 'adapt'},...
    'Position', [10 10 100 30], 'FontSize', 15, 'Tag', 'param_band_meth');

% RTB
uicontrol('Style', 'pushbutton', 'String', 'RTB',...
    'Position', [230 10 60 50], 'FontSize', 15,...
    'BackgroundColor', GUI.Colors(2,:), 'Tag', 'compute_RTB',...
    'callback', 'global GUI, Theta_Beta_Ratio_V04()');
% Save
uicontrol('Style', 'pushbutton', 'String', 'Save',...
    'Position', [300 10 60 50], 'FontSize', 15,...
